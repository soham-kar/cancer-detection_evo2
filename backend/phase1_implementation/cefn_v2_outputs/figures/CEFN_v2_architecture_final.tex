...
\node[annot, below=0.05cm of embed_region.south] {Predictor‑specific missing embeddings};

% ==================================================================
% ROW 2: DEEP SETS (centered below)
% ==================================================================
\node[network, fill=evidencepurple!10, draw=evidencepurple, below=0.9cm of evo2cat, xshift=1.5cm, minimum width=4.5cm] (deepset_phi) 
    {$\varphi$ MLP (shared)};
