...
export default function SignInPage() {
    ...
    useEffect(() => {
        ...
        // Phase 2: Transition to login after animation
    ...
    return (
        <div className="flex min-h-screen items-center justify-center overflow-hidden relative">
            ...
            <div className="relative w-full max-w-md px-4">
                ...
                {/* LOGIN FORM - Small Logo + Form + Try Demo */}
                <div
                ...
                >
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-xs text-[#3c4f3d]/50 uppercase tracking-wider">or sign in</span>
                        <div className="flex-1 h-px bg-[#3c4f3d]/20" />
                    </div>
